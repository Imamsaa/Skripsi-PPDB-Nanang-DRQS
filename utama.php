      ...
      <h4>DATA PENDAFTAR</h1>
        ...
        <form id="daftarppdb" name="daftarppdb" action="proses/daftar.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="sekolah" type="text" id="asal_sekolah" name="asal_sekolah" placeholder="ASAL SEKOLAH" required>
              <datalist id="sekolah">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="tempat" type="text" id="tempat_lahir" name="tempat_lahir" placeholder="TEMPAT LAHIR" required>
              <datalist id="tempat">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="alamatsiswa" type="text" id="alamat" name="alamat" placeholder="NAMA JALAN / DUSUN" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input type="text" id="dusun" list="listdusun" class="form-control" placeholder="NAMA DUSUN" name="dusun">
            ...
            <div class="col-sm-5">
              <input type="text" id="desa" list="listdesa" class="form-control" placeholder="NAMA DESA" name="desa">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input type="text" id="kecamatan" list="listkecamatan" class="form-control" placeholder="NAMA KECAMATAN" name="kecamatan" required>
          ...
          <div class="col-sm-3">
            ...
            <div class="col-sm-3">
              <input type="text" id="kabupaten" list="listkabupaten" class="form-control" placeholder="NAMA KABUPATEN" name="kabupaten" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input type="text" id="provinsi" list="listprov" class="form-control" placeholder="NAMA PROVINSI" name="provinsi" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" type="text" list="do" id="domisili" name="domisili" placeholder="NAMA DAERAH TINGGAL" required>
              <datalist id="do">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <img class="img-thumbnail" id="blah" src="#" alt="FOTO SISWA" />
            </div>
            <div class="col-sm-6">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="alamatsiswa" type="text" id="data_ayah_alamat" name="data_ayah_alamat" placeholder="NAMA JALAN/DUSUN" required>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="tempat" type="text" id="data_ayah_tempat_lahir" name="data_ayah_tempat_lahir" placeholder="TEMPAT LAHIR" required>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="alamatsiswa" type="text" id="data_ibu_alamat" name="data_ibu_alamat" placeholder="NAMA JALAN/DUSUN" required>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="tempat" type="text" id="data_ibu_tempat_lahir" name="data_ibu_tempat_lahir" placeholder="TEMPAT LAHIR" required>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="alamatsiswa" type="text" id="data_wali_alamat" name="data_wali_alamat" placeholder="NAMA JALAN/DUSUN">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control" list="tempat" type="text" id="data_wali_tempat_lahir" name="data_wali_tempat_lahir" placeholder="TEMPAT LAHIR">
            </div>
          </div>
          <div class="form-group row">
