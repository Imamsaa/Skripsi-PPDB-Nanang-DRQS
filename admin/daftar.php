  ...
  <div class="card mb-3">
    <div class="card-body">
      <h4>DATA PENDAFTAR</h1>
        <br>
      <form id="daftarppdbadmin" name="daftarppdbadmin" action="" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input class="form-control" type="text" id="wgnegara" name="wgnegara" placeholder="...">
          </div>
        </div>
        <div class="form-group row">
          <label for="nowa" class="col-sm-3 col-form-label">NO WA : <span style="color:red;"><strong>*</strong></span></label>
          <div class="col-sm-4">
        ...
        <div class="form-group row">
          <label for="hubayah" class="col-sm-3 col-form-label">HUBUNGAN DGN PENDAFTAR : <span style="color:red;"><strong>*</strong></span></label>
          <div class="col-sm-4">
            <input class="form-control" type="text" id="hubayah" name="hubayah" placeholder="..." required>
          </div>
        </div>
        <br>
        <h5>B. DATA IBU</h5>
        ...
        <div class="form-group row">
          <label for="hubibu" class="col-sm-3 col-form-label">HUBUNGAN DGN PENDAFTAR : <span style="color:red;"><strong>*</strong></span></label>
          <div class="col-sm-4">
            <input class="form-control" type="text" id="hubibu" name="hubibu" placeholder="..." required>
          </div>
        </div>
        <br>
        ...
        <div class="form-group row">
          <label for="pickupdate" class="col-sm-3 col-form-label">TANGGAL LAHIR :</label>
          <div class="col-sm-4">
            <input type="date" class="form-control" name="tanggallahirwali" id="pickupdate">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          <label for="hubwali" class="col-sm-3 col-form-label">HUBUNGAN DGN PENDAFTAR :</label>
          <div class="col-sm-4">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-2">
            <button type="button" data-toggle="modal" data-target="#modaldaftaradmin" class="btn btn-primary btn-block">DAFTAR</button>
          </div>
        </div>
      </form>
    </div>
