      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="index.php?hal=home" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='home'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=pembayaran" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='pembayaran'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=konpembayaran" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='konpembayaran'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=verifikasi" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='verifikasi'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=wawancara" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='wawancara'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=keputusan" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='keputusan'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=daftarulang" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='daftarulang'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=lapor" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='lapor'){echo 'active';}} ?>">
          ...
          <li class="nav-item">
            <a href="index.php?hal=setting" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='setting'){echo 'active';}} ?>">
              <i class="nav-icon far fa-plus-square"></i>
              <p>
                Setting
              </p>
          ...
          <li class="nav-item">
            <a href="index.php?hal=pengu" class="nav-link <?php if(isset($_GET['hal'])){if($_GET['hal']=='pengu'){echo 'active';}} ?>">
